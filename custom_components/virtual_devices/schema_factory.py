        ...
        return {
            vol.Optional("sensor_type", default="temperature"): vol.In(
                [
                    ...
                    "pm25", "pm10", "pm1", "pm4",
                    "co2", "carbon_monoxide", "voc", "formaldehyde",
                    "nitrogen_monoxide", "nitrogen_dioxide",
                    "nitrous_oxide", "ozone", "sulphur_dioxide",
                    "aqi", "radon", "noise", "uv_index", "rainfall",
                    "wind_speed", "water_quality", "ph", "signal_strength",
                    "volume", "weight", "distance", "irradiance", "moisture",
                    "frequency", "timestamp", "duration",
                    "absolute_humidity", "apparent_power", "area",
                    "blood_glucose_concentration", "conductivity",
                    "data_rate", "data_size", "energy_distance",
                    "energy_storage", "monetary", "power_factor",
                    "precipitation_intensity", "reactive_energy",
                    "reactive_power", "speed", "temperature_delta",
                    "volatile_organic_compounds_parts", "volume_storage",
                    "wind_direction",
                ]
            ),
        }
